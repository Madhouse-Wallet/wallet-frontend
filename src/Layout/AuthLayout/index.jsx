  ...
  return (
    <>
      <AuthSec className="authLayout py-5 z-10 relative flex items-center justify-center">
        <div className="absolute top-0 left-0 h-full w-full transition-opacity fill-mode-both opacity-100 pointer-events-none fixed inset-0 w-full scale-125 object-cover object-center blur-[var(--wallpaper-blur)] duration-700 h-lvh backdrop-blur-md z-[-9]"></div>
