        ...
        <div className="container">
          <div className="grid gap-3 grid-cols-12">
            <div className="col-span-12 my-3">
              <div className="sectionHeader pb-2 border-bottom border-secondary mb-4">
                <div className="d-flex align-items-center gap-2">
                  ...
                  <h4 className="m-0 text-2xl font-bold">My Wallet</h4>
                </div>
              </div>
            </div>
            <div className="col-span-12 my-3">
              <div className="right">
                <WalletLink className="d-flex align-items-center gap-3">
                  <button className="d-flex align-items-center justify-content-start text-start p-3">
            ...
            <div className="md:col-span-6 col-span-12 my-2">
                ...
                <div className="d-flex align-items-start justify-content-between flex-wrap">
                  <div className="left ">
                    ...
                    >
                      ...
                      <div className="top pt-3 d-flex align-items-center justify-content-between gap-3">
                        <div className="content">
              ...
              <div className="py-2">
                <RadioList className="list-unstyled ps-0 mb-0 d-flex align-items-center justify-content-start gap-3 pb-4">
                  <li className="position-relative">
                    ...
                    />
                    <button className="d-flex align-items-center justify-content-center fw-sbold p-2">
                      Bank Transfer
                    </button>
                  </li>
                  <li className="position-relative">
                ...
                <CardCstm className="p-3 d-flex align-items-center justify-content-between flex-wrap gap-3 rounded position-relative">
