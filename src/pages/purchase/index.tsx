            ...
            <div className="col-span-12 my-2">
              <div className="sectionHeader pb-2 border-bottom border-secondary mb-4">
                <div className="d-flex align-items-center gap-3">
                  ...
                  <h4 className="m-0 font-bold text-2xl">Purchase Yubikeys</h4>
                </div>
              </div>
            </div>
            <div className="col-span-12 my-2">
                  ...
                  <div className="grid gap-3 grid-cols-12">
                    <div className="col-span-6 my-2">
                      <div className="cardCstm text-center">
                        <div className="icnWrp flex items-center justify-center mb-3">
                          {packageIcn}
                        </div>
                        <p className="m-0 fw-sbold themeClr pb-1">Shipping</p>
