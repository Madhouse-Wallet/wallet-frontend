...
const FeatureSec: React.FC = () => {
  return (
    <>
      <FeatureSection className=" relative pb-5 pt-14 z-10 bg-[#090400]">
            ...
            <div className="col-span-12">
              <div className="text-center mx-auto" style={{ maxWidth: 600 }}>
                ...
                <p className="m-0 py-2">
                  Discover the power of Madhouse Wallet’s decentralized
                  features, offering secure, self-custodial Bitcoin borrowing
                  with no KYC, smart contract security, and tax-efficient
                  liquidity solutions.
                </p>
              </div>
            </div>
            <div className="col-span-12">
              <div className="grid gap-3 iwt grid-cols-12 py-4">
                <div className="lg:col-span-4 sm:col-span-6 col-span-12 ">
                  <ul className="list-none p-3 mb-0">
                    <li className="py-4 border-b border-gray-400 flex items-start gap-3">
                      <div
                        className="icn rounded-3 flex flex-shrink-0 items-center justify-center border border-secondary"
                      ...
                      <div className="content">
                        ...
                        <p className="m-0 py-2 text-gray-400">
                          Secure offline storage with multi-signature approval.
                        </p>
                      </div>
                    </li>
                    <li className="py-4 border-b border-gray-400 flex items-start gap-3">
                      ...
                      <div className="content">
                        ...
                        <p className="m-0 py-2 text-gray-400">
                          Rigorous audits for integrated protocols.
                        </p>
                      </div>
                    </li>
                    <li className="py-4 border-b border-gray-400 flex items-start gap-3">
                      ...
                      <div className="content">
                        ...
                        <p className="m-0 py-2 text-gray-400">
                          Protection through Nexus Mutual insurance.
                        </p>
                      </div>
                    </li>
                  </ul>
                </div>
                <div className="lg:col-span-4 sm:col-span-6 col-span-12 imgWrpper">
                  <div className="p-3">
                    <Image
                      src={img}
                      alt="feature"
                  ...
                  <ul className="list-none p-3 mb-0">
                    <li className="py-4 border-b border-gray-400 flex items-start gap-3">
                      ...
                      <div className="content">
                        ...
                        <p className="m-0 py-2 text-gray-400">
                          Manage seed phrases and secure recovery.
                        </p>
                      </div>
                    </li>
                    <li className="py-4 border-b border-gray-400 flex items-start gap-3">
                      ...
                      <div className="content">
                        ...
                        <p className="m-0 py-2 text-gray-400">
                          Test transfers and phishing protection.
                        </p>
                      </div>
                    </li>
                    <li className="py-4 border-b border-gray-400 flex items-start gap-3">
