...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        const { userId, email, colleralAmount, borrowAmount, walletAddress } = req.body;
        ...
        // Insert the new user
        const result = await usersCollection.insertOne({ userId, email, colleralAmount, borrowAmount, walletAddress, createdAt: new Date() });
