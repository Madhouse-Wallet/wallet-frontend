...
const DepositTab = ({ provider, account }) => {
  ...
  const SPENDER_ADDRESS =
    process.env.NEXT_PUBLIC_CURVE_SPENDER_CONTRACT_ADDRESS;
              ...
              <div className="right">
                <div className="flex items-center gap-2">
                  {token.name == "USDT" ? (
                    ...
                    <>
                      <Image
                        src={process.env.NEXT_PUBLIC_IMAGE_URL + "thusd.jpg"}
                        alt="thusd"
                        height={1000}
                        width={1000}
                        className="max-w-full w-auto object-contain rounded-full"
                        style={{ height: 24 }}
                      />
                    </>
                  ) : (
...
const usdtIcn = (
  ...
  >
    <path
      d="M9 15.2L0 6.32L3.433 0.800003H14.567L18 6.32L9 15.2ZM9.9 7.1V6.002C11.52 6.082 13.032 6.398 13.5 6.807C12.956 7.284 11.007 7.631 9 7.631C6.993 7.631 5.044 7.284 4.5 6.807C4.963 6.397 6.48 6.087 8.1 5.997V7.1H9.9ZM4.5 6.803V7.464C4.963 7.874 6.475 8.184 8.1 8.274V10.7H9.9V8.27C11.52 8.189 13.036 7.874 13.5 7.464V6.146C13.036 5.736 11.52 5.421 9.9 5.336V4.4H12.6V3.05H5.4V4.4H8.1V5.336C6.475 5.421 4.963 5.736 4.5 6.146V6.803Z"
      fill="#009393"
    />
  </svg>
);
