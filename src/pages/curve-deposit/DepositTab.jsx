...
import thusdImg from "@/Assets/Images/thusd.jpg"
        ...
        {tokens.map((token) => (
          <div className="my-2" key={token.name}>
            <div className="bg-black/50 p-3 rounded-lg flex items-center justify-between">
              ...
              <div className="right">
                <div className="flex items-center gap-2">{token.name == "USDT" ? <>{usdtIcn}</> : token.name == "USDC" ? <>{usdcIcn}</> : token.name == "DAI" ? <>{daiIcn}</> : token.name == "THUSD" ? <><Image src={thusdImg} alt="thusd" height={1000} width={1000} className="max-w-full w-auto object-contain rounded-full" style={{height: 24}} /></> : <></>}</div>
              </div>
            </div>
          </div>
        ))}
...
const daiIcn = <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.675 0.871002H1.742V6.097H0V8.42H1.742V9.58H0V11.903H1.742V17.129H8.675C10.3259 17.1308 11.9386 16.6324 13.3006 15.6995C14.6627 14.7666 15.7101 13.443 16.305 11.903H18V9.581H16.815C16.8432 9.19418 16.8432 8.80582 16.815 8.419H18V6.098H16.305C15.7089 4.55882 14.6612 3.23596 13.2994 2.30325C11.9376 1.37053 10.3256 0.870597 8.675 0.871002ZM14.481 9.582C14.521 9.19534 14.521 8.808 14.481 8.42H4.065V9.582H14.487H14.481ZM4.065 11.904V14.807H8.547C10.754 14.807 12.687 13.64 13.715 11.904H4.065ZM4.065 6.097H13.721C13.1847 5.20705 12.4264 4.47163 11.5205 3.96275C10.6146 3.45387 9.59205 3.18897 8.553 3.194H4.065V6.097Z" fill="#FDC134"/>
</svg>



const usdcIcn = <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const usdtIcn = <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9 15.2L0 6.32L3.433 0.800003H14.567L18 6.32L9 15.2ZM9.9 7.1V6.002C11.52 6.082 13.032 6.398 13.5 6.807C12.956 7.284 11.007 7.631 9 7.631C6.993 7.631 5.044 7.284 4.5 6.807C4.963 6.397 6.48 6.087 8.1 5.997V7.1H9.9ZM4.5 6.803V7.464C4.963 7.874 6.475 8.184 8.1 8.274V10.7H9.9V8.27C11.52 8.189 13.036 7.874 13.5 7.464V6.146C13.036 5.736 11.52 5.421 9.9 5.336V4.4H12.6V3.05H5.4V4.4H8.1V5.336C6.475 5.421 4.963 5.736 4.5 6.146V6.803Z" fill="#009393"/>
</svg>
