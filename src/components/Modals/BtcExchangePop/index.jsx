...
const BtcExchangePop = ({ btcExchange, setBtcExchange,   walletAddress, qrCode, loading, setLoading, mint, startReceive }) => {
        ...
        <Modal.Body className={`position-relative rounded`}>
          ...
          <div className="content p-3">
            <div className="cardCstm p-3 text-center">
              ...
              <form action="">
                <div className="grid gap-3 grid-cols-12">
                  <div className="col-span-12">
                    <input type="text" onChange={(e)=>(setRecoveryAddress(e.target.value))} className="form-control text-xs rounded" style={{height: 45}} required />
                  </div>
                  <div className="col-span-12">
                    <button type="button" onClick={submitAddress} className="btn w-full flex itmes-center justify-center commonBtn">
                      Submit
                    </button>
                  </div>
                </div>
              ...
              {loading ? <>
              <Image src={loader} height={10000} width={10000} className="max-w-full mx-auto w-auto" style={{height: 40}}/>
              </> : <>
              <Image src={qrCode} height={10000} width={10000} className="max-w-full mx-auto h-auto w-auto" />
              </>}
