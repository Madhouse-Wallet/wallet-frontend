...
const InvoicePop = ({ invoiceePop, setInvoicePop, qrCodee }) => {
  ...
  const handleReceiveUSDC = () => setInvoicePop(!invoiceePop);
              ...
              <div className="cardCstm text-center">
                ...
                <div className="content mt-2" style={{ fontSize: 12 }}>
                  <div className="text-center py-5">
                    <h6 className="m-0 text-base pb-2">Your Invoice</h6>
